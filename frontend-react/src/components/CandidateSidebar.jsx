...
function CandidateSidebar() {
  ...
  const handleElectionDate = () => {
    navigate("/candidate/view/election-dates");
  }

  const handleResults = () => {
    navigate("/candidate/view/results");
  }
        ...
        <div className="sidebar-section2 mt-3">
          ...
          <div className="sidebar-icons-container">
            <div onClick={nominate} className="icon-container">
              ...
              <span>Fill Nomination Form</span>
            </div>
          ...
          <div className="sidebar-icons-container">
            <div onClick={handleElectionDate} className="icon-container">
              ...
              <span>All Election Dates</span>
            </div>

            <div onClick={handleResults} className="icon-container">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
