...
function PartySidebar() {
  ...
  const handleKYC = () => {
    navigate("/party/party-candidate");
  };
  ...
  const handleFeedback = () => {
    navigate("/party/feedback");
  };

  const handleComplaint = () => {
    navigate("/party/complaint");
  };
  ...
  const handleProfile = () => {
    navigate("/party/profile");
  };

  const handleDate = () => {
    navigate("/party/view/date");
  };

  const handleResult = () => {
    navigate("/party/view/result");
  };
        ...
        <div className="sidebar-section2 mt-3">
          ...
          <div className="sidebar-icons-container">
            ...
            <div onClick={handleKYC} className="icon-container">
              ...
              <span>Manage Your Candidate</span>
            </div>
          ...
          <div className="sidebar-icons-container sidebar-icons-container-last">
            <div onClick={handleProfile} className="icon-container ml-5">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
