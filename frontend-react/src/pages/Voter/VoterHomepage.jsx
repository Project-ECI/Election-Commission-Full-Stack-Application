            ...
            <div className="homepage-container">
                <div className="left-homepage-container">
                    <div className="sticky-sidebar">
                        <div className="sidebar-section1 shadow">
                ...
                <div className="right-homepage-container">
                    ...
                    <button className="btn btn-blue mt-2" style={{width: "53%"}}>Download Voter-Id</button>

                    <div className="article mt-5">
                        <h1 className="font-mont text-center">Become a Better Voter</h1>
                    </div>
                </div>
            </div>
